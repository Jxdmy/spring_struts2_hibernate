...
public class PagingTag extends TagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        if (totalCount == 0) {
            ...
            sb.append("<form method=\"get\" action=\"").append(this.url).append("\" name=\"pagingForm\" onsubmit=\"return false\">\r\n");
            ...
            sb.append("    loadListPage(no,").append(pageSize).append(",\"").append(url).append("\");\r\n");
            //sb.append("    loadListPageData();\r\n");
            sb.append("  }\r\n");
            sb.append("</script>\r\n");
        }
        sb.append("</div>\r\n");
